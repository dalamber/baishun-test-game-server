...
## Update SSToken for a user
#### Powershell
```powershell
curl -Method Post -Uri "https://baishun.badsantos.com/v1/api/update_sstoken" -ContentType "application/json" -Body '{"app_id":21397507, "user_id" : "id1001","ss_token":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9", "signature" : "c62d04ebdb5100e475f45f5ebe8c64ee", "signature_nonce":"5f0eb04d7603a9d8","timestamp":1682674598}' Select-Object -Expand Content
```
#### Bash
```bash
curl -X POST "https://baishun.badsantos.com/v1/api/update_sstoken" \
     -H "Content-Type: application/json" \
     -d '{"app_id":21397507, "user_id" : "id1001","ss_token":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9", "signature" : "c62d04ebdb5100e475f45f5ebe8c64ee", "signature_nonce":"5f0eb04d7603a9d8","timestamp":1682674598}'
